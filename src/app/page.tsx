...
export default function Home() {
  ...
  const translations = {
    en: {
      ...
      description1:
        "ItinaryMe is a travel application designed to centralize your travel planning and booking experience. We aim to provide personalized travel recommendations and planning, giving you the flexibility to customize your flights, hotels, and activities, all while streamlining the payment process.",
      description2:
      ...
      personalizedTripDescription:
        "Tailoired itineraries to match your unique interests, preferences, and travel style.",
      ...
      customizedItinerariesDescription:
        "Receive a day-by-day itinerary crafted to your interests and preferences.", expertPlanning: "Expert Planning",
      expertPlanningDescription:
        "Our travel specialists use their knowledge to create your perfect trip.", seamlessExperience: "Seamless Experience",
    ...
    fr: {
      ...
      personalizedTripDescription:
        "Itinéraires personnalisés pour correspondre à vos intérêts, préférences et style de voyage uniques.",
      ...
      expertPlanningDescription:
        "Nos spécialistes du voyage utilisent leurs connaissances pour créer votre voyage parfait.", seamlessExperience: "Expérience fluide",
      seamlessExperienceDescription:
        "Profitez d'un voyage sans tracas avec les réservations et les détails organisés pour vous.",
